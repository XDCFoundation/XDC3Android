...
public class UserprofileActivity extends AppCompatActivity {
    ...
    private void getXDCBalance() {
        try {
            SharedPreferenceHelper.setSharedPreferenceString(UserprofileActivity.this,
                    "xdc",
                    String.valueOf(XDC20Client.getInstance()
                            .getXdcBalance(user_wallet.getAccountAddress())));
        } catch (IOException e) {
            e.printStackTrace();
        }
        String xdc = SharedPreferenceHelper.getSharedPreferenceString(UserprofileActivity.this, "xdc", "");
