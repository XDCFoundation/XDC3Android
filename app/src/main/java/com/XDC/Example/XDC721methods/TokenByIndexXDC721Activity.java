...
public class TokenByIndexXDC721Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        user_wallet = Utility.getProfile(TokenByIndexXDC721Activity.this);
        tokenDetail = Utility.getnftinfo(TokenByIndexXDC721Activity.this);
                ...
                if (!hasText(token_address)) {
                    ...
                    token_index.setError(getResources().getString(R.string.error_empty));
                        ...
                        try {
                           ...
                           // SharedPreferenceHelper.setSharedPreferenceString(TokenByIndexXDC721Activity.this, "nfthash", hash);                        } catch (Exception e) {
