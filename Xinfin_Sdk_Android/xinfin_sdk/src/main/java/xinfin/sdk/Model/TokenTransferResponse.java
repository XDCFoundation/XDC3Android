...
public class TokenTransferResponse   {
    ...
    public boolean equals(Object o) {
        ...
        if (transactionIndex != null
                ? !transactionIndex.equals(that.getTransactionIndex())
        ...
        if (blockNumber != null
                ? !blockNumber.equals(that.getBlockNumber())
                : that.getBlockNumber() != null) {
            return false;
        }
        if (cumulativeGasUsed != null
                ? !cumulativeGasUsed.equals(that.getCumulativeGasUsed())
                : that.getCumulativeGasUsed() != null) {
            return false;
        }
        if (gasUsed != null ? !gasUsed.equals(that.getGasUsed()) : that.getGasUsed() != null) {
            return false;
        }
